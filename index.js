...
const varOne = 'this is one';
let varTwo = 'this is two';

if(varOne === 'this is one') {
  varTwo = 'this is also one now';
  console.log('task 1b', varTwo);
}
...
*/
let numConvert = +'1999';
console.log('task 1c', numConvert);
/*
Task 1d - Multiply
...
console.log('task 1d', multiply(5, 15));
